...
def farthest_point_sample(xyz, npoint):
    ...
    distance = torch.ones(B, N).to(device) * 1e16
    farthest = 0 #torch.randint(0, N, (B,), dtype=torch.long).to(device)
...
class PointNetSetAbstraction(nn.Module):
    ...
    def forward(self, xyz, points):
        ...
        if self.group_all:
            ...
            # print('here')
            # print(new_points.permute(0,3,1,2).shape)
            # print(new_points.permute(0,3,1,2))
        ...
        # print(f'new_points2: {new_points.shape}')
        # print(new_points)
